...
<body>
	...
	<a href="index.html" class="logo">
		<span class="symbol"><img src="img/upp.png" alt="" /></span><span class="title">Sistema Integral Extracurricular</span>
	</a>
 Image and text -->
      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-login">
          <div class="panel-heading">
            <div class="row">
              <div class="col-xs-6">
                <a href="#" class="active" id="login-form-link">Ingresar Datos</a>
              </div>
            <!--  <div class="col-xs-6">
          ...
          <div class="panel-body">
            <div class="row">
              <div class="col-lg-12">
                <form id="login-form" action="<?php echo base_url('index.php/Control/guardar'); ?> " method="post" role="form" style="display: block; "onsubmit="return validar();">
                  ...
                  <div class="form-group">
                    <input type="email" name="correo" id="correo" tabindex="1" class="form-control" placeholder="Correo" value="" required>
                  </div>
                  <div class="form-group">
